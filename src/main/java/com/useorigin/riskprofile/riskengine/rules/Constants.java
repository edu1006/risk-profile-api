...
public class Constants {
    ...
    public static final int POINTS_VEHICLE_AGE_RULE = 1;
    public static final Integer TAGET_AGE_VALIDATION_RULE_ABOVE_TARGET_VALUE = 60;
    public static final Integer USER_DEPENDENS_QUANTITY_ABOVE_VALIDATION = 1;
    public static final int USER_DEPENDENTS_RULE_POINTS = 1;
    ...
    public static final int TRUE_VALUE_AS_INT = 1;
    public static final Double INCOME_TO_BE_VALIDATE_PLUS_VALIDATION_OF_ALL_RISK_QUESTIONS = 25000.00;
